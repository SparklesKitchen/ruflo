/**
 * Code Intelligence Plugin for Ruflo V3
 *
 ...
 *
 * @module @ruflo/plugin-code-intelligence
 */
...
export const pluginMetadata = {
  ...
  homepage: 'https://github.com/SparklesKitchen/ruflo',
  repository: 'https://github.com/SparklesKitchen/ruflo.git',
};
