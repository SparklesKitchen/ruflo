 ...
 *
 * Bridge between GUPP work tracking and Ruflo session management.
...
/**
 * Session manager interface (Ruflo compatible)
 */
...
/**
 * GUPP Adapter - Bridge between Gas Town work tracking and Ruflo sessions
 *
