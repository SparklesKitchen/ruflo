 ...
 * - register(): Register with codex plugin system
...
// ============================================================================
// Plugin Interfaces (matching codex plugin system)
// ============================================================================
...
/**
 * Gas Town Bridge Plugin for Ruflo V3
 *
...
export class GasTownBridgePlugin extends EventEmitter implements IPlugin {
  readonly name = '@ruflo/plugin-gastown-bridge';
