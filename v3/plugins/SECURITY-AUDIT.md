...
- `@ruflo/plugin-agentic-qe@3.0.0-alpha.2` (28 files, ~17,036 LOC)
- `@ruflo/plugin-prime-radiant@0.1.4` (21 files, ~9,136 LOC)
...
sandbox:
  ...
  filesystem:
    ...
    blockedPaths:
      ...
      - ~/.aws
      - ~/.config
      - node_modules/@ruflo/security  # Prevent reading security module
```
...
```typescript
// MUST use SafeExecutor from @ruflo/security
import { SafeExecutor } from '@ruflo/security';
...
import { z } from 'zod';
import { PathSchema, IdentifierSchema, SafeStringSchema } from '@ruflo/security';
...
```typescript
import { aidefence } from '@ruflo/aidefence';
...
- [ ] PathValidator imported from `@ruflo/security`
- [ ] SafeExecutor imported from `@ruflo/security`
- [ ] InputValidator imported from `@ruflo/security`
...
// src/schemas.ts
import { z } from 'zod';
import { IdentifierSchema } from '@ruflo/security';
...
**Published Versions:**
- `@ruflo/plugin-agentic-qe@3.0.0-alpha.2`
- `@ruflo/plugin-prime-radiant@0.1.4`
