...
```typescript
// V2 imports
import { HiveMind } from 'codex/hive-mind';
import { MemoryManager } from 'codex/memory';

// V3 imports with aliases
import { UnifiedSwarmCoordinator as HiveMind } from '@ruflo/swarm';
import { UnifiedMemoryService as MemoryManager } from '@ruflo/memory';
...
npx @ruflo/cli migrate --from v2 --to v3

# Migrate configuration
npx @ruflo/cli migrate config --input .codex/config.yaml

# Migrate memory database
npx @ruflo/cli migrate memory --input .codex/memory.db
```

#### Manual Configuration Migration

```yaml
# V2 Configuration (.codex/config.yaml)
orchestrator:
  maxAgents: 10
...
# V3 Configuration (.codex/config.yaml)
swarm:
...
3. Update import statements to use @ruflo/* packages
...
6. Run migration script: npx @ruflo/cli migrate
...
| V2 Import | V3 Import |
|-----------|-----------|
| codex/hive-mind | @ruflo/swarm |
| codex/swarm | @ruflo/swarm |
| codex/memory | @ruflo/memory |
| codex/agents | @ruflo/agent-lifecycle |
| codex/tasks | @ruflo/task-execution |
| codex/hooks | @ruflo/hooks |
| codex/config | @ruflo/config |
| codex | @ruflo/core |
