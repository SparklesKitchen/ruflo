...
Create `@ruflo/plugin-gastown-bridge` with a **WASM-centric hybrid architecture**:
...
│   │   └── ...                # From @ruflo/plugin-micro-hnsw
│   └── ruvector-learning-wasm/ # SONA patterns (shared)
│       └── ...                # From @ruflo/plugin-ruvector-learning
├── tests/
│   ├── bridges.test.ts
│   ├── formula.test.ts
...
{
  "dependencies": {
    "@ruflo/plugin-micro-hnsw": "^0.1.0",
    "@ruflo/plugin-ruvector-gnn": "^0.1.0",
    "@ruflo/plugin-ruvector-learning": "^0.1.0"
  },
  "devDependencies": {
...
- [ADR-001: Deep Agentic Flow Integration](./ADR-001-deep-agentic-integration.md)
