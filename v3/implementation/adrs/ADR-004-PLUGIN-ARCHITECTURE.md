...
```typescript
class PluginManager {
  private plugins: Map<string, CodexFlowPlugin> = new Map();
...
**Official Plugins:**
1. `@ruflo/hive-mind` - Queen-led coordination
2. `@ruflo/neural` - Neural training system
3. `@ruflo/verification` - Truth scoring
4. `@ruflo/enterprise` - Advanced features
