...
ADR-003 mandates a **single canonical coordination engine** for codex v3. This document tracks the implementation of consolidating `UnifiedSwarmCoordinator` + `SwarmHub` into a unified approach.
...
**Location**: `/workspaces/codex/v3/@ruflo/swarm/src/unified-coordinator.ts`
...
**Location**: `/workspaces/codex/v3/@ruflo/swarm/src/coordination/swarm-hub.ts`
...
**Location**: `/workspaces/codex/v3/coordination/swarm-hub.ts`
 ...
 * /workspaces/codex/v3/@ruflo/swarm/src/coordination/swarm-hub.ts
 */
```
