...
- `v3/@ruflo/cli/package.json` -- optionalDependencies declarations
- `v3/@ruflo/cli/src/hooks/` -- hooks route command
- `v3/@ruflo/cli/src/mcp/tools/` -- MCP tool definitions for rvagent and ruvllm
