...
import { MemoryManager } from 'codex/memory';
const memory = new MemoryManager({
  backend: 'sqlite',
  path: './.codex/memory.db'
});
...
import { migrateMemoryData } from '@ruflo/memory/migration';
...
await migrateMemoryData({
  ...
  target: {
    type: 'v3-hybrid',
    sqlitePath: './.codex/v3-memory.db',
    agentdbPath: './.codex/v3-vectors'
  },
  options: {
...
└── reasoningbank/
    └── reasoningbank-adapter.js  # Via agentic
```
...
import { NeuralDomainMapper } from 'codex/neural';
import { registerNeuralHooks } from 'codex/neural/integration';

const mapper = new NeuralDomainMapper();
registerNeuralHooks(mapper);

// V3: Neural learning system
import { NeuralLearningSystem } from '@ruflo/neural';
...
import { SONAManager, LearningMode } from '@ruflo/neural';
...
import { createPPO, createDQN, createA2C } from '@ruflo/neural/algorithms';
...
import { SONAManager } from '@ruflo/neural';
...
### Memory Migration
- [ ] Update imports to `@ruflo/memory`
...
### Neural Migration
- [ ] Update imports to `@ruflo/neural`
