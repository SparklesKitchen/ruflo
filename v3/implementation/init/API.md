...
**Example:**
```typescript
import { detectPlatform } from '@ruflo/cli/init';
...
```typescript
import { generateSettings, generateSettingsJson } from '@ruflo/cli/init';
...
```typescript
import { generateMCPConfig, generateMCPJson, generateMCPCommands } from '@ruflo/cli/init';
...
// ['codex mcp add codex -- npx @ruflo/cli mcp start', ...]
```
...
```typescript
import { generateStatuslineScript, generateStatuslineHook } from '@ruflo/cli/init';
...
const result = await executeInit({
  ...
  sourceBaseDir: '/path/to/codex', // Source for skills/commands/agents
  force: true,
  components: {
...
```typescript
import { executeInit, detectPlatform, DEFAULT_INIT_OPTIONS } from '@ruflo/cli/init';
...
```typescript
import { executeInit, MINIMAL_INIT_OPTIONS } from '@ruflo/cli/init';
