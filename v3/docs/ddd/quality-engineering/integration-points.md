...
This document describes how the Quality Engineering (agentic-qe) plugin integrates with Ruflo V3's existing domains: Security, Core, Memory, Integration, and Coordination.
...
│   │   Translates between agentic-qe and codex V3 domains              │   │
│   └─────────────────────────────────────────────────────────────────────────┘   │
│                                        │                                         │
│     ┌──────────────┬──────────────────┼──────────────────┬──────────────┐       │
│     │              │                  │                  │              │       │
...
import type { IMemoryService, MemoryEntry } from '@ruflo/memory';
...
The QE domain reuses V3's `@ruflo/embeddings` service instead of running separate `@xenova/transformers` instances:
...
import type { AgentService, TaskService, WorkflowService } from '@ruflo/core';
...
import type { HiveMindService, ConsensusResult } from '@ruflo/coordination';
...
import type { MCPServer, ToolDefinition } from '@ruflo/mcp';
