# Architectural Comparison: Ruflo V3 vs Codex TeammateTool

**Date:** 2026-01-25
**Analysis:** Side-by-side comparison of Ruflo V3 swarm architecture (developed by rUv) and Codex's TeammateTool (discovered in v2.1.19)

---

## Executive Summary

A detailed analysis reveals **striking architectural similarities** between Ruflo V3's swarm system and Codex's TeammateTool. The terminology differs, but the core concepts, data structures, and workflows are nearly identical.
...
60+ agent types defined in AGENTS.md configuration
```
...
| **Persistence** | In-memory + optional persist | `~/.codex/teams/{team}/mailbox/` |
...
**Ruflo V3 approach:**
- Agents run as sub-processes via Codex Task tool
...
CODEX_TEAMMATE_COMMAND   # Spawn command
```
...
| **2026-01-24** | TeammateTool discovered in Codex v2.1.19 |
...
- AGENTS.md configuration predates TeammateTool discovery
...
**Author:** Analysis by Codex (commissioned by rUv)
**Sources:** Ruflo V3 source code, Codex v2.1.19 binary analysis
