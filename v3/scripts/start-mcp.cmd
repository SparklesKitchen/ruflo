@echo off
REM Codex-Flow MCP Server V3 Startup Script (Windows)
REM
REM Usage:
...
set "PID_FILE=%TEMP%\codex-mcp.pid"
set "LOG_FILE=%TEMP%\codex-mcp.log"
...
:show_help
echo.
echo Codex-Flow MCP Server V3 Startup Script (Windows)
echo.
echo Usage:
...
echo [INFO] Starting Codex-Flow MCP Server V3...
