...
> **Modular AI Agent Coordination System** - A complete reimagining of Codex-Flow with 15-agent hierarchical mesh swarm coordination.

[![Version](https://img.shields.io/badge/version-3.0.0--alpha.1-blue.svg)](https://github.com/SparklesKitchen/ruflo)
...
│   │       └── domain/                 # DDD entities
│   │
│   ├── integration/                 # agentic integration
│   │   └── src/
│   │       ├── agentic-bridge.ts  # Core bridge
...
│   ├── codex-v3.sh            # Master helper (Linux/macOS)
│   ├── codex-v3.ps1           # Master helper (Windows)
...
```typescript
import { PasswordHasher, validateInput, sanitizePath } from '@ruflo/security';
...
```typescript
import { HybridMemoryRepository, HNSWIndex } from '@ruflo/memory';
...
### @ruflo/integration
Deep integration with agentic@alpha per ADR-001.

```typescript
import { AgenticFlowBridge } from '@ruflo/integration';
...
```typescript
import { BenchmarkRunner, formatTime } from '@ruflo/performance';
...
```typescript
import { SONAAdapter } from '@ruflo/neural';
...
```bash
npx @ruflo/cli swarm init --topology hierarchical-mesh
npx @ruflo/cli agent spawn --type queen-coordinator
npx @ruflo/cli memory search "knowledge"
```
...
```typescript
import { createMockAgent, createTestFixture } from '@ruflo/testing';
...
```typescript
import { EventBus, Result, success, failure } from '@ruflo/shared';
import type { AgentId, TaskStatus } from '@ruflo/shared/types';
```
...
```typescript
import { initializeV3Swarm } from '@ruflo/v3';
...
```typescript
// Import everything
import * as codexFlow from '@ruflo/v3';

// Or import specific modules for tree-shaking
import { UnifiedSwarmCoordinator } from '@ruflo/swarm';
import { PasswordHasher } from '@ruflo/security';
...
```typescript
import { createMCPServer } from '@ruflo/v3/mcp';
...
```bash
# Linux/macOS
./helpers/codex-v3.sh init
./helpers/codex-v3.sh status
./helpers/codex-v3.sh update domain 3

# Windows (PowerShell)
.\helpers\codex-v3.ps1 init
.\helpers\codex-v3.ps1 status
.\helpers\codex-v3.ps1 update domain 3
```
...
git clone https://github.com/SparklesKitchen/ruflo.git
cd codex/v3
...
### Modules
- [@ruflo/security](./@ruflo/security/)
- [@ruflo/memory](./@ruflo/memory/)
- [@ruflo/swarm](./@ruflo/swarm/)
- [@ruflo/integration](./@ruflo/integration/)
- [@ruflo/performance](./@ruflo/performance/)
- [@ruflo/neural](./@ruflo/neural/)
- [@ruflo/cli](./@ruflo/cli/)
- [@ruflo/testing](./@ruflo/testing/)
- [@ruflo/shared](./@ruflo/shared/)
- [@ruflo/deployment](./@ruflo/deployment/)

### Examples
- [AgentDB Example](./@ruflo/memory/examples/agentdb-example.ts)
- [Cross-Platform Usage](./@ruflo/memory/examples/cross-platform-usage.ts)
...
### External
- [GitHub Repository](https://github.com/SparklesKitchen/ruflo)
- [agentic Integration](https://github.com/ruvnet/agentic)
