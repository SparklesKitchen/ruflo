...
- `/workspaces/codex/v3/mcp/types.ts` - MCP type definitions
- `/workspaces/codex/v3/mcp/server.ts` - MCP server implementation
- `/workspaces/codex/v3/mcp/tool-registry.ts` - Tool registration system
- `/workspaces/codex/AGENTS.md` - Project documentation
