/**
 * Ruflo V3 - Modular AI Agent Coordination System
 *
 * This is the main entry point that re-exports all @codex modules.
...
// =============================================================================
// @codex Module Exports (New Modular Architecture)
// =============================================================================

/**
 * Security module - CVE fixes, input validation, credential management
 * @see {@link @ruflo/security}
 */
export * as security from './@ruflo/security/src/index.js';

/**
 * Memory module - AgentDB, HNSW indexing, vector search
 * @see {@link @ruflo/memory}
 */
export * as memory from './@ruflo/memory/src/index.js';

/**
 * Swarm module - 15-agent coordination, hierarchical mesh, consensus
 * @see {@link @ruflo/swarm}
 */
export * as swarm from './@ruflo/swarm/src/index.js';

/**
 * Integration module - agentic@alpha integration, ADR-001 compliance
 * @see {@link @ruflo/integration}
 */
export * as integration from './@ruflo/integration/src/index.js';

/**
 * Shared module - common types, events, utilities, core interfaces
 * @see {@link @ruflo/shared}
 */
export * as shared from './@ruflo/shared/src/index.js';

/**
 * CLI module - Command parsing, prompts, output formatting
 * @see {@link @ruflo/cli}
 */
export * as cli from './@ruflo/cli/src/index.js';

/**
 * Neural module - SONA learning, neural modes
 * @see {@link @ruflo/neural}
 */
export * as neural from './@ruflo/neural/src/index.js';

/**
 * Performance module - Benchmarking, Flash Attention validation
 * @see {@link @ruflo/performance}
 */
export * as performance from './@ruflo/performance/src/index.js';

/**
 * Testing module - TDD London School framework, test utilities
 * @see {@link @ruflo/testing}
 */
export * as testing from './@ruflo/testing/src/index.js';

/**
 * Deployment module - Release management, CI/CD
 * @see {@link @ruflo/deployment}
 */
export * as deployment from './@ruflo/deployment/src/index.js';
...
export const V3_INFO = {
  ...
  description: 'Complete reimagining of Codex-Flow with 15-agent hierarchical mesh swarm',
