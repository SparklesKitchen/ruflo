#!/bin/bash
# Ruflo V3 Configuration Validator Template (Linux/macOS)
...
echo -e "${BLUE}🔍 Ruflo V3 Configuration Validation${RESET}"
echo "==========================================="
echo ""

# Check required directories
echo "📁 Checking Directory Structure..."
required_dirs=(".codex" ".codex/helpers" ".codex/metrics" ".codex/security")
...
required_files=(".codex/metrics/v3-progress.json" ".codex/metrics/performance.json" ".codex/security/audit-status.json")
