...
[![npm version](https://img.shields.io/npm/v/@ruflo/swarm.svg)](https://www.npmjs.com/package/@ruflo/swarm)
[![npm downloads](https://img.shields.io/npm/dm/@ruflo/swarm.svg)](https://www.npmjs.com/package/@ruflo/swarm)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![ADR-003](https://img.shields.io/badge/ADR--003-Compliant-green.svg)](https://github.com/SparklesKitchen/ruflo)
[![Agents](https://img.shields.io/badge/Agents-Up%20to%20100+-orange.svg)](https://github.com/SparklesKitchen/ruflo)
...
| **Integration** | 10-12 | agentic integration, CLI, neural features |
...
```typescript
import { createSwarmHub } from '@ruflo/swarm';
...
```typescript
import { createQueenCoordinator } from '@ruflo/swarm';
...
```typescript
import { createAttentionCoordinator } from '@ruflo/swarm';
...
```typescript
import { createFederationHub, getDefaultFederationHub } from '@ruflo/swarm';
...
## Integration with agentic@alpha

This module can integrate with agentic@alpha for enhanced capabilities:

```typescript
import { createUnifiedSwarmCoordinator } from '@ruflo/swarm';
import { AgenticFlowBridge } from '@ruflo/integration';

// Connect to agentic for enhanced features
...
const coordinator = createUnifiedSwarmCoordinator({
  topology: { type: 'hierarchical', maxAgents: 15 },
  // Enable agentic features via bridge
  extensions: {
...
Based on agentic@alpha capabilities that could be integrated:
