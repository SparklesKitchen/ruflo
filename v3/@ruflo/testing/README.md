...
[![npm version](https://img.shields.io/npm/v/@ruflo/testing.svg)](https://www.npmjs.com/package/@ruflo/testing)
[![npm downloads](https://img.shields.io/npm/dm/@ruflo/testing.svg)](https://www.npmjs.com/package/@ruflo/testing)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![TDD](https://img.shields.io/badge/TDD-London%20School-purple.svg)](https://github.com/SparklesKitchen/ruflo)
[![ADR-008](https://img.shields.io/badge/ADR--008-Vitest-green.svg)](https://vitest.dev/)

> Comprehensive testing framework for V3 Codex-Flow modules. Implements London School TDD patterns with behavior verification, shared fixtures, and mock services.
...
```bash
npm install @ruflo/testing vitest --save-dev
```
...
```typescript
import { createMockClock, measureTime } from '@ruflo/testing';
...
```typescript
import { createTestEmitter } from '@ruflo/testing';
...
```typescript
import { MockAgentDB } from '@ruflo/testing';
...
```typescript
import { MockSwarmCoordinator } from '@ruflo/testing';
...
```typescript
import { MockMCPClient, createStandardMockMCPClient } from '@ruflo/testing';
...
```typescript
import { registerCustomMatchers } from '@ruflo/testing';
...
```typescript
import { setupV3Tests, configureTestEnvironment } from '@ruflo/testing';
...
```typescript
import { createSetupContext, createTestScope } from '@ruflo/testing';
...
```typescript
import { createPerformanceTestHelper } from '@ruflo/testing';
...
```typescript
import { assertV3PerformanceTargets, TEST_CONFIG } from '@ruflo/testing';
