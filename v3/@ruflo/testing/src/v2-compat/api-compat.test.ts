...
describe('V2 API Compatibility', () => {
  ...
  describe('Import Path Aliases', () => {
    ...
    it('should resolve codex/hive-mind to @ruflo/swarm', () => {
      const resolved = mockRegistry.resolveImport('codex/hive-mind');

      expect(resolved).toBe('@ruflo/swarm');
    });

    it('should resolve codex/memory to @ruflo/memory', () => {
      const resolved = mockRegistry.resolveImport('codex/memory');

      expect(resolved).toBe('@ruflo/memory');
    });
