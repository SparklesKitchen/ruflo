...
Environment Variables:
  RUFLO_STATUSLINE_REFRESH   Refresh interval in ms
  RUFLO_SHOW_HOOKS_METRICS   Show hooks metrics (true/false)
  RUFLO_SHOW_SWARM_ACTIVITY  Show swarm activity (true/false)
  RUFLO_SHOW_PERFORMANCE     Show performance targets (true/false)
...
`);
  ...
  const generator = new StatuslineGenerator({
    enabled: true,
    refreshOnHook: true,
    showHooksMetrics: process.env.RUFLO_SHOW_HOOKS_METRICS !== 'false',
    showSwarmActivity: process.env.RUFLO_SHOW_SWARM_ACTIVITY !== 'false',
    showPerformance: process.env.RUFLO_SHOW_PERFORMANCE !== 'false',
  });
