...
[![npm version](https://img.shields.io/npm/v/@ruflo/performance.svg)](https://www.npmjs.com/package/@ruflo/performance)
[![npm downloads](https://img.shields.io/npm/dm/@ruflo/performance.svg)](https://www.npmjs.com/package/@ruflo/performance)
...
```typescript
import { benchmark } from '@ruflo/performance';
...
- [@ruflo/memory](../memory) - Memory operations to benchmark
- [@ruflo/swarm](../swarm) - Swarm coordination to benchmark
- [@ruflo/neural](../neural) - Neural operations to benchmark
