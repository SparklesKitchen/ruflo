...
```typescript
import { createFlashAttentionOptimizer } from '@ruflo/performance';
...
```typescript
import { quickBenchmark } from '@ruflo/performance';
...
```typescript
import { quickValidation } from '@ruflo/performance';
...
```typescript
import { runAndDisplaySuite } from '@ruflo/performance';
...
```bash
# Run all examples
npx tsx v3/@ruflo/performance/src/examples/flash-attention-demo.ts
```
...
```typescript
import { FlashAttentionOptimizer } from '@ruflo/performance';
