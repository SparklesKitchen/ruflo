import type { MCPToolDefinition } from '@ruflo/shared/src/plugin-interface.js';
import type { PluginContext } from '@ruflo/shared/src/plugin-interface.js';
  ...
  return [
    {
      ...
      pluginName: '@ruflo/plugin-agent-federation',
