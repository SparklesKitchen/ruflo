...
describe('AgentFederationPlugin', () => {
  ...
  describe('interface compliance', () => {
    it('should have name set to @ruflo/plugin-agent-federation', () => {
      expect(plugin.name).toBe('@ruflo/plugin-agent-federation');
    });
    ...
    it('should have author set to Ruflo Team', () => {
      expect(plugin.author).toBe('Ruflo Team');
    });

    it('should declare @ruflo/security as a dependency', () => {
      expect(plugin.dependencies).toContain('@ruflo/security');
    });

    it('should declare @ruflo/aidefence as a dependency', () => {
      expect(plugin.dependencies).toContain('@ruflo/aidefence');
    });
