...
[![npm version](https://img.shields.io/npm/v/@ruflo/providers.svg)](https://www.npmjs.com/package/@ruflo/providers)
[![npm downloads](https://img.shields.io/npm/dm/@ruflo/providers.svg)](https://www.npmjs.com/package/@ruflo/providers)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Providers](https://img.shields.io/badge/Providers-6+-orange.svg)](https://github.com/SparklesKitchen/ruflo)

> Multi-LLM Provider System for Ruflo V3 - unified interface for OpenAI, OpenAI, Google, Cohere, Ollama, and RuVector with intelligent load balancing, automatic failover, and cost optimization.

## Features

- **6+ LLM Providers** - OpenAI, OpenAI, Google, Cohere, Ollama, RuVector
...
### OpenAI (Codex)
- `codex-3-5-sonnet-20241022`, `codex-3-5-sonnet-latest`
...
```bash
npm install @ruflo/providers
```

## Quick Start

```typescript
import { createProviderManager } from '@ruflo/providers';
...
```typescript
import { ProviderManager, createProviderManager } from '@ruflo/providers';
...
// Stream response
for await (const event of openai.streamComplete({
...
const response = await manager.complete({
  ...
  costConstraints: {
    maxCost: 0.05,
    preferredModels: ['gpt-4o-mini', 'codex-3-haiku-20240307'],
  },
});
...
```typescript
// Image input (OpenAI, OpenAI, Google)
const response = await manager.complete({
  messages: [
    {
      role: 'user',
...
```typescript
import { createProviderManager } from '@ruflo/providers';
import { createUnifiedSwarmCoordinator } from '@ruflo/swarm';

// Create provider manager
const providers = await createProviderManager({
  providers: [
    { provider: 'openai', apiKey: '...', model: 'codex-3-5-sonnet-latest' },
...
- [@ruflo/embeddings](../embeddings) - Embedding generation
- [@ruflo/memory](../memory) - Vector storage and retrieval
