...
const TEST_PROMPT = 'Say "Hello from Ruflo V3!" Be brief.';
...
async function testOpenAI() {
  ...
  const provider = new OpenAIProvider({
    config: {
      provider: 'openai',
      apiKey,
      model: 'codex-3-haiku-20240307', // Use cheaper, widely-available model
      maxTokens: 100,
    },
...
async function main() {
  console.log('╔════════════════════════════════════════════════╗');
  console.log('║     Ruflo V3 - Provider Test Suite       ║');
  console.log('╚════════════════════════════════════════════════╝');
