...
// Test configuration
const TEST_PROMPT = 'Say "Hello from Ruflo V3!" in exactly 5 words.';
...
describe('Provider Integration Tests', () => {
  ...
  describe('OpenAI Provider', () => {
    ...
    it.skipIf(!apiKey)('should complete request with Codex 3.5 Sonnet', async () => {
    ...
    it.skipIf(!apiKey)('should complete request via OpenRouter', async () => {
      const provider = new OpenAIProvider({
        config: {
          ...
          providerOptions: {
            headers: {
              'HTTP-Referer': 'https://codex.dev',
              'X-Title': 'Ruflo V3 Test',
            },
          },
        },
        logger: consoleLogger,
  ...
  describe('Provider Manager', () => {
    ...
    it.skipIf(!openaiKey && !googleKey)('should manage multiple providers with failover', async () => {
    ...
    it.skipIf(!openaiKey)('should use cache for repeated requests', async () => {
  ...
  describe('Cost Estimation', () => {
    ...
    it.skipIf(!apiKey)('should estimate costs accurately', async () => {
      ...
      const estimate = estimates.get('openai');
