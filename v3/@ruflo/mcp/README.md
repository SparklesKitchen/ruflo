...
[![npm version](https://img.shields.io/npm/v/@ruflo/mcp.svg)](https://www.npmjs.com/package/@ruflo/mcp)
...
[![Standalone](https://img.shields.io/badge/Module-Standalone-green.svg)](https://github.com/SparklesKitchen/ruflo)
...
- **Zero Dependencies** - No @ruflo/* dependencies

## Installation

```bash
npm install @ruflo/mcp
```

## Quick Start

```typescript
import { quickStart, defineTool } from '@ruflo/mcp';
...
```typescript
import { createToolRegistry, defineTool } from '@ruflo/mcp';
...
```typescript
import { createSessionManager } from '@ruflo/mcp';
...
```typescript
import { createConnectionPool } from '@ruflo/mcp';
...
```typescript
import { createMCPServer, createTextResource } from '@ruflo/mcp';
...
```typescript
import { createMCPServer, definePrompt, textMessage, interpolate } from '@ruflo/mcp';
