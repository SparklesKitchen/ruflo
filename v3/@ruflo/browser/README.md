...
[![npm version](https://img.shields.io/npm/v/@ruflo/browser?style=for-the-badge&logo=npm&color=blue)](https://www.npmjs.com/package/@ruflo/browser)
...
**AI-Optimized Browser Automation for Codex-Flow Swarms**

*Integrate [agent-browser](https://github.com/AugmentCode/agent-browser) with codex for intelligent web automation, trajectory learning, security scanning, and multi-agent browser coordination.*
...
`@ruflo/browser` provides a comprehensive browser automation layer for AI agents, combining Vercel Labs' `agent-browser` CLI with codex's learning, memory, and security capabilities. It enables agents to navigate websites, fill forms, extract data, and learn from successful interaction patterns.
...
npm install @ruflo/cli@^3.0.0-alpha
...
```typescript
import { createBrowserService, browserTools } from '@ruflo/browser';
...
Register browser tools with codex's MCP server:

```typescript
import { browserTools } from '@ruflo/browser';
...
```typescript
import { createMemoryManager } from '@ruflo/browser';
...
```typescript
import { listWorkflows, getWorkflow, getWorkflowManager } from '@ruflo/browser';
...
```typescript
import { preBrowseHook, postBrowseHook, browserHooks } from '@ruflo/browser';
...
```typescript
import { createBrowserSwarm } from '@ruflo/browser';
...
```typescript
import { createBrowserService, getSecurityScanner } from '@ruflo/browser';
...
- [Codex-Flow Documentation](https://github.com/SparklesKitchen/ruflo#readme)
...
**Part of the [Codex-Flow](https://github.com/SparklesKitchen/ruflo) ecosystem**
