/**
 * @ruflo/browser - Memory Integration Tests
 */
...
describe('CodexFlowMemoryAdapter', () => {
  let adapter: CodexFlowMemoryAdapter;

  beforeEach(() => {
    adapter = new CodexFlowMemoryAdapter('test-browser');
  });
