...
[![npm version](https://img.shields.io/npm/v/@ruflo/deployment.svg)](https://www.npmjs.com/package/@ruflo/deployment)
[![npm downloads](https://img.shields.io/npm/dm/@ruflo/deployment.svg)](https://www.npmjs.com/package/@ruflo/deployment)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![CI/CD](https://img.shields.io/badge/CI%2FCD-Automated-green.svg)](https://github.com/SparklesKitchen/ruflo)
[![Semantic Release](https://img.shields.io/badge/Semantic-Release-brightgreen.svg)](https://semantic-release.gitbook.io/)

> Release management, CI/CD, and versioning module for Ruflo v3.
...
```typescript
import { prepareRelease } from '@ruflo/deployment';
...
```typescript
import { publishToNpm } from '@ruflo/deployment';
...
```typescript
import { validate } from '@ruflo/deployment';
...
```typescript
import { Publisher } from '@ruflo/deployment';
...
```typescript
import { Validator } from '@ruflo/deployment';
