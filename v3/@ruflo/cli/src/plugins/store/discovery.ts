...
export const DEFAULT_PLUGIN_STORE_CONFIG: PluginStoreConfig = {
  ...
  defaultRegistry: 'codex-official',
  gateway: 'https://gateway.pinata.cloud',
  timeout: 30000,
...
export class PluginDiscoveryService {
  ...
  private async createDemoRegistryAsync(registry: KnownPluginRegistry): Promise<PluginDiscoveryResult> {
    ...
    const demoRegistry: PluginRegistry = {
      ...
      totalDownloads: plugins.reduce((sum, p) => sum + p.downloads, 0),
      totalAuthors: 1,
      featured: ['@ruflo/plugin-iot-cognitum', '@ruflo/plugin-agent-federation', '@ruflo/plugin-agentic-qe', '@ruflo/plugin-prime-radiant', '@ruflo/security', '@ruflo/claims', '@ruflo/teammate-plugin'],
      trending: ['@ruflo/plugin-iot-cognitum', '@ruflo/plugin-agent-federation', '@ruflo/plugin-agentic-qe', '@ruflo/plugin-prime-radiant'],
      newest: ['@ruflo/plugin-iot-cognitum', '@ruflo/plugin-agent-federation', '@ruflo/plugin-agentic-qe', '@ruflo/plugin-prime-radiant'],
      official: ['@ruflo/plugin-iot-cognitum', '@ruflo/plugin-agent-federation', '@ruflo/plugin-agentic-qe', '@ruflo/plugin-prime-radiant', '@ruflo/security', '@ruflo/claims'],
      compatibilityMatrix: [
        { pluginId: '@ruflo/neural', pluginVersion: '3.0.0', codexFlowVersions: ['3.x'], tested: true },
        { pluginId: '@ruflo/security', pluginVersion: '3.0.0', codexFlowVersions: ['3.x'], tested: true },
      ],
    };
    ...
    return [
      {
        ...
        minCodexFlowVersion: '3.0.0',
        dependencies: [{ name: '@ruflo/core', version: '^3.0.0' }],
        type: 'core',
      ...
      {
        id: '@ruflo/performance',
        name: '@ruflo/performance',
      ...
      {
        id: '@ruflo/plugin-prime-radiant',
        name: '@ruflo/plugin-prime-radiant',
      ...
      {
        id: '@ruflo/plugin-healthcare-clinical',
        name: '@ruflo/plugin-healthcare-clinical',
      ...
      {
        id: '@ruflo/plugin-financial-risk',
        name: '@ruflo/plugin-financial-risk',
      ...
      {
        id: '@ruflo/plugin-legal-contracts',
        name: '@ruflo/plugin-legal-contracts',
      ...
      {
        id: '@ruflo/plugin-code-intelligence',
        name: '@ruflo/plugin-code-intelligence',
      ...
      {
        id: '@ruflo/plugin-test-intelligence',
      ...
      {
        id: '@ruflo/plugin-perf-optimizer',
        name: '@ruflo/plugin-perf-optimizer',
      ...
      {
        id: '@ruflo/plugin-neural-coordination',
        name: '@ruflo/plugin-neural-coordination',
      ...
      {
        id: '@ruflo/plugin-quantum-optimizer',
        name: '@ruflo/plugin-quantum-optimizer',
      ...
      {
        id: '@ruflo/plugin-hyperbolic-reasoning',
        name: '@ruflo/plugin-hyperbolic-reasoning',
      ...
      {
        id: '@ruflo/plugin-gastown-bridge',
        name: '@ruflo/plugin-gastown-bridge',
      ...
      {
        id: '@ruflo/plugin-agent-federation',
        name: '@ruflo/plugin-agent-federation',
        ...
        minCodexFlowVersion: '3.0.0',
        dependencies: [{ name: '@ruflo/security', version: '^3.0.0' }],
        type: 'integration',
      ...
      // IoT Cognitum - Cognitum Seed device-agent bridge
      {
        ...
        minCodexFlowVersion: '3.0.0',
        dependencies: [
          { name: '@ruflo/shared', version: '^3.0.0' },
      ...
      // Teammate Plugin - Codex v2.1.19+ integration
      {
        id: '@ruflo/teammate-plugin',
        name: '@ruflo/teammate-plugin',
        displayName: 'Teammate Plugin',
        description: 'Native TeammateTool integration for Codex v2.1.19+. Multi-agent team orchestration with plan approval workflows, delegation, messaging, and BMSSP-optimized topology routing. 21 MCP tools.',
        version: '1.0.0-alpha.1',
        ...
        tags: ['teammate', 'codex-code', 'multi-agent', 'swarm', 'orchestration', 'bmssp'],
        keywords: ['teammate', 'codex-code', 'multi-agent'],
        downloads: 0,
        rating: 0,
        ratingCount: 0,
        lastUpdated: baseTime,
  ...
  private async getDemoPluginsWithStats(): Promise<PluginEntry[]> {
    ...
    const realNpmPackages = [
      '@ruflo/plugin-agentic-qe',
      '@ruflo/plugin-prime-radiant',
      '@ruflo/claims',
      '@ruflo/security',
      '@ruflo/plugins',
      '@ruflo/embeddings',
      ...
      // Domain-specific plugins
      '@ruflo/plugin-healthcare-clinical',
      '@ruflo/plugin-financial-risk',
      '@ruflo/plugin-legal-contracts',
      // Development intelligence plugins
      '@ruflo/plugin-code-intelligence',
      '@ruflo/plugin-test-intelligence',
      '@ruflo/plugin-perf-optimizer',
      // Advanced AI/reasoning plugins
      '@ruflo/plugin-neural-coordination',
      '@ruflo/plugin-quantum-optimizer',
      '@ruflo/plugin-hyperbolic-reasoning',
      // Gas Town Bridge
      '@ruflo/plugin-gastown-bridge',
      // Agent Federation
      '@ruflo/plugin-agent-federation',
      // IoT Cognitum
      '@ruflo/plugin-iot-cognitum',
    ];
