...
async function main() {
  console.log('');
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║  RUFLO V3 - STANDALONE PLUGIN STORE TEST               ║');
  ...
  try {
    const similar = findSimilarPlugins(registry, '@ruflo/neural', 3);
    console.log(`  ✅ Found ${similar.length} similar plugins to @ruflo/neural`);
    passed++;
  } catch (e) {
    console.log(`  ❌ Failed: ${(e as Error).message}`);
    failed++;
  ...
  if (failed === 0) {
    ...
    console.log('    npx @ruflo/cli plugins list');
    console.log('    npx @ruflo/cli plugins list --official');
    console.log('    npx @ruflo/cli plugins search -q "plugin creator"');
    console.log('    npx @ruflo/cli plugins info -n plugin-creator');
    console.log('');
  }
