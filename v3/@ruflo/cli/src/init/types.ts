 ...
 * Configuration options for initializing Codex integration
 */
...
export interface InitComponents {
  /** Create .codex/settings.json with hooks */
  settings: boolean;
  ...
  agents: boolean;
  /** Create helper scripts in .codex/helpers/ */
  helpers: boolean;
  /** Configure statusline */
  statusline: boolean;
  /** Create MCP configuration */
  mcp: boolean;
  /** Create .codex/ directory (V3 runtime) */
  runtime: boolean;
  /** Create AGENTS.md with swarm guidance */
  codexMd: boolean;
}

/**
 * Hook configuration options
 * Valid Codex hook events (23 total):
...
export interface SkillsConfig {
  ...
  v3: boolean;
  /** Include dual-mode skills (Codex + Codex hybrid) */
  dualMode: boolean;
...
export interface AgentsConfig {
  ...
  testing: boolean;
  /** Include dual-mode agents (Codex + Codex hybrid) */
  dualMode: boolean;
  /** Include all agents */
  all: boolean;
}
...
export interface RuntimeConfig {
  ...
  /** AGENTS.md template variant */
  codexMdTemplate?: CodexMdTemplate;
}

/** Template variants for generated AGENTS.md files */
export type CodexMdTemplate = 'minimal' | 'standard' | 'full' | 'security' | 'performance' | 'solo';
...
export interface InitOptions {
  ...
  /**
   * Skip the user-global ~/.codex/AGENTS.md "Ruflo Integration" pointer block.
   * Defaults to false (current behavior — block is appended once, idempotent).
   * Set true via --no-global to keep the global Codex rules file pristine (#1744).
   */
  skipGlobalCodexMd?: boolean;
  /**
   * #1670 — opt in to writing the `attribution` block in `.codex/settings.json`
