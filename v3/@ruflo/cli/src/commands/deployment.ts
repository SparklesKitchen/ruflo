...
const deployCommand: Command = {
  ...
  examples: [
    { command: 'codex deployment deploy -e prod', description: 'Deploy to production' },
    { command: 'codex deployment deploy --dry-run', description: 'Simulate deployment' },
  ],
...
const statusCommand: Command = {
  ...
  examples: [
    { command: 'codex deployment status', description: 'Show all environments' },
    { command: 'codex deployment status -e prod', description: 'Check production' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
      const state = loadDeploymentState(ctx.cwd);
...
const rollbackCommand: Command = {
  ...
  examples: [
    { command: 'codex deployment rollback -e prod', description: 'Rollback production' },
    { command: 'codex deployment rollback -e prod -v v3.0.0', description: 'Rollback to specific version' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
...
const historyCommand: Command = {
  ...
  examples: [
    { command: 'codex deployment history', description: 'Show all history' },
    { command: 'codex deployment history -e prod', description: 'Production history' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
      const state = loadDeploymentState(ctx.cwd);
...
const environmentsCommand: Command = {
  ...
  examples: [
    { command: 'codex deployment environments', description: 'List environments' },
    { command: 'codex deployment envs -a add -n preview -t staging', description: 'Add environment' },
    { command: 'codex deployment envs -a remove -n preview', description: 'Remove environment' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
...
const logsCommand: Command = {
  ...
  examples: [
    { command: 'codex deployment logs -e prod', description: 'View production logs' },
    { command: 'codex deployment logs -d dep-123', description: 'View specific deployment' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
      const state = loadDeploymentState(ctx.cwd);
...
const releaseCommand: Command = {
  ...
  examples: [
    { command: 'codex deployment release -v 3.5.0', description: 'Release version 3.5.0' },
    { command: 'codex deployment release -v 3.5.0 -d "Major update"', description: 'Release with description' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
...
export const deploymentCommand: Command = {
  ...
  examples: [
    { command: 'codex deployment deploy -e prod', description: 'Deploy to production' },
    { command: 'codex deployment status', description: 'Check all environments' },
    { command: 'codex deployment rollback -e prod', description: 'Rollback production' },
    { command: 'codex deployment release -v 3.5.0', description: 'Create a release' },
  ],
