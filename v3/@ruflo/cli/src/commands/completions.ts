...
complete -F _ruflo_flow_completions codex
complete -F _ruflo_flow_completions npx\\ @ruflo/cli@v3alpha
`;
}
...
export const completionsCommand: Command = {
  ...
  options: [],
  examples: [
    { command: 'ruflo completions bash > ~/.bash_completion.d/codex', description: 'Install bash completions' },
    { command: 'ruflo completions zsh > ~/.zfunc/_codex', description: 'Install zsh completions' },
    { command: 'ruflo completions fish > ~/.config/fish/completions/codex.fish', description: 'Install fish completions' },
