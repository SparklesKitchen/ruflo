...
export const initCommand: Command = {
  ...
  examples: [
    ...
    { command: 'ruflo init --only-codex', description: 'Only create Codex integration' },
    { command: 'ruflo init --skip-codex', description: 'Only create V3 runtime' },
    ...
    { command: 'ruflo init --dual', description: 'Initialize for both Codex and Codex' },
  ],
  action: initAction,
};
