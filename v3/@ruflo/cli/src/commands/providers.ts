...
const PROVIDER_CATALOG: ProviderCatalogEntry[] = [
  { name: 'OpenAI', type: 'LLM', models: 'codex-3.5-sonnet, opus', envVar: 'OPENAI_API_KEY', configName: 'openai' },
...
const modelsCommand: Command = {
  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.printTable({
      ...
      data: [
        { model: 'codex-3.5-sonnet-20241022', provider: 'OpenAI', capability: 'Chat', context: '200K', cost: '$0.003/$0.015' },
        { model: 'codex-3-opus-20240229', provider: 'OpenAI', capability: 'Chat', context: '200K', cost: '$0.015/$0.075' },
...
const usageCommand: Command = {
  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.printTable({
      ...
      data: [
        { provider: 'OpenAI', requests: '12,847', tokens: '4.2M', cost: '$12.60', trend: output.warning('↑ 15%') },
