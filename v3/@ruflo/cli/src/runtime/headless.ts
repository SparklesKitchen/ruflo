 ...
 *
 * Usage:
 *   npx @ruflo/cli headless --worker <type>
 *   npx @ruflo/cli headless --daemon
 *   npx @ruflo/cli headless --benchmark
 *
 * Environment:
 *   RUFLO_HEADLESS=true
 *   CODEX_HEADLESS=true
...
Environment:
  RUFLO_HEADLESS=true   Enable headless mode
  CODEX_HEADLESS=true   Enable Codex headless
...
async function showStatus(): Promise<void> {
  ...
  console.log('\nEnvironment:');
  console.log(`  RUFLO_HEADLESS: ${process.env.RUFLO_HEADLESS || 'not set'}`);
  console.log(`  CODEX_HEADLESS: ${process.env.CODEX_HEADLESS || 'not set'}`);
...
async function main(): Promise<void> {
  ...
  process.env.RUFLO_HEADLESS = 'true';
