...
const COMPATIBILITY_MATRIX: Record<string, Record<string, PackageCompatibility>> = {
  '@ruflo/cli': {
    ...
    '@ruflo/security': { minVersion: '3.0.0-alpha.1' },
    '@ruflo/integration': { minVersion: '3.0.0-alpha.1' },
  },
  '@ruflo/embeddings': {
    '@ruflo/cli': { minVersion: '3.0.0-alpha.50' },
  },
  '@ruflo/integration': {
    '@ruflo/cli': { minVersion: '3.0.0-alpha.70' },
    'agentic': { minVersion: '3.0.0-alpha.1' },
  },
};
