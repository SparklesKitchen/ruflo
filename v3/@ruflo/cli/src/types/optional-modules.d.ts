...
declare module 'agentic/reasoningbank' {
...
declare module 'agentic/agent-booster' {
...
declare module 'agentic/intelligence/agent-booster-enhanced' {
  export class EnhancedAgentBooster { constructor(...args: any[]); }
  export function getEnhancedBooster(...args: any[]): any;
  export function enhancedApply(opts: { code: string; edit: string; language?: string }): Promise<{ confidence: number; output: string }>;
  export function benchmark(...args: any[]): Promise<any>;
...
declare module 'agentic/sdk' {
  const sdk: any;
  export default sdk;
}

declare module 'agentic/security' {
  const security: any;
  export default security;
}

declare module 'agentic/transport/quic' {
  const quic: any;
  export default quic;
}
...
// Optional @codex sibling packages (installed separately)
// Using permissive `any` types since these are runtime-resolved optional deps
declare module '@ruflo/embeddings' {
  const mod: any;
  export default mod;
...
declare module '@ruflo/aidefence' {
