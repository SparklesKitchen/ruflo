 ...
 * .codex/sessions/*.json files keep working unchanged.
 */
...
const ENV_ENABLE_FLAG = 'RUFLO_ENCRYPT_AT_REST';
const ENV_KEY_VAR = 'RUFLO_ENCRYPTION_KEY';
...
/**
 * Resolve a 32-byte encryption key from RUFLO_ENCRYPTION_KEY.
 *
