 ...
 *
 * @module @ruflo/cli/ruvector
 */

export { QLearningRouter, createQLearningRouter, type QLearningRouterConfig, type RouteDecision } from './q-learning-router.js';
// #1773 item 4 — moe-router migrated to @ruflo/neural. Direct
// consumers (hooks-tools.ts) import from '@ruflo/neural' explicitly;
...
// #1773 item 4 — flash-attention migrated to @ruflo/neural. Direct
// consumers (hooks-tools.ts, neural-tools.ts) import from '@ruflo/neural'
