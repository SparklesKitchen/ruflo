...
RuVector is a high-performance vector database for Node.js with automatic native/WASM fallback. It provides self-learning intelligence for Codex with Q-learning optimization, vector memory, and automatic agent routing.
