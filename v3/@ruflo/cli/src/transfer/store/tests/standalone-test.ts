...
async function main() {
  console.log('');
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║  RUFLO V3 - STANDALONE PATTERN STORE TEST              ║');
  ...
  if (failed === 0) {
    ...
    console.log('    npx @ruflo/cli patterns list');
    console.log('    npx @ruflo/cli patterns list --featured');
    console.log('    npx @ruflo/cli patterns search -q "agent"');
    console.log('    npx @ruflo/cli patterns info -n <pattern-id>');
    console.log('');
  }
