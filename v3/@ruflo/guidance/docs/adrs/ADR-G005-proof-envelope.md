...
- `v3/@ruflo/guidance/src/types.ts` -- `RunEvent`, `Violation`, `EvaluatorResult`, `ViolationRanking`, `OptimizationMetrics`
- `v3/@ruflo/guidance/src/ledger.ts` -- `RunLedger`, all evaluator classes
- `v3/@ruflo/guidance/src/compiler.ts` -- `hashContent()` for guidance hash generation
- `v3/@ruflo/guidance/src/index.ts` -- `GuidanceControlPlane.startRun()`, `finalizeRun()`
