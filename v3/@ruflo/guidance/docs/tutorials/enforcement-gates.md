...
Gates become more powerful when loaded with compiled rules from `AGENTS.md`:
...
// Now gates also enforce your custom AGENTS.md rules
```
...
```ts
import { createGuidanceHooks } from '@ruflo/guidance/hooks';
