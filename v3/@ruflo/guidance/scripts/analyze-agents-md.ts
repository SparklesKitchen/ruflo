...
// Analyze both the root AGENTS.md and v3/AGENTS.md
const ROOT_CODEX_MD = resolve(import.meta.dirname!, '../../../../AGENTS.md');
const V3_CODEX_MD = resolve(import.meta.dirname!, '../../../AGENTS.md');

const CODEX_MD_PATH = ROOT_CODEX_MD;

// Read the current file
const original = readFileSync(CODEX_MD_PATH, 'utf-8');

console.log('='.repeat(80));
console.log('  AGENTS.md ANALYSIS & OPTIMIZATION REPORT');
console.log('  Target: ' + CODEX_MD_PATH);
...
const outputPath = CODEX_MD_PATH.replace('.md', '.optimized.md');
writeFileSync(outputPath, optimized.optimized, 'utf-8');
console.log('  Optimized file saved to: ' + outputPath);
console.log();

// Also analyze v3/AGENTS.md if it exists
try {
  const v3Content = readFileSync(V3_CODEX_MD, 'utf-8');
  console.log('='.repeat(80));
  console.log('  BONUS: v3/AGENTS.md ANALYSIS');
  console.log('  Target: ' + V3_CODEX_MD);
  console.log('='.repeat(80));
  console.log();
