 ...
 *
 * Bridges ruvbot (npm: ruvbot@0.1.8) with the @ruflo/guidance control
 ...
 *
 * @module @ruflo/guidance/ruvbot-integration
 */
...
async function requireRuvBot(): Promise<Record<string, unknown>> {
  ...
  try {
    ...
    throw new Error(
      ...
      'ruvbot is an optional peer dependency of @ruflo/guidance.',
    );
  }
}
...
/**
 * Bridges a ruvbot instance with the @ruflo/guidance control plane.
 *
