...
[![npm version](https://img.shields.io/npm/v/@ruflo/security.svg)](https://www.npmjs.com/package/@ruflo/security)
[![npm downloads](https://img.shields.io/npm/dm/@ruflo/security.svg)](https://www.npmjs.com/package/@ruflo/security)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Security Audit](https://img.shields.io/badge/Security-Audited-green.svg)](https://github.com/SparklesKitchen/ruflo)

> Comprehensive security module for Ruflo V3 - CVE fixes, input validation, path security, and secure credential management.
...
```bash
npm install @ruflo/security
```

## Quick Start

```typescript
import { createSecurityModule } from '@ruflo/security';
...
```typescript
import { PasswordHasher, createPasswordHasher } from '@ruflo/security';
...
```typescript
import { CredentialGenerator, generateCredentials } from '@ruflo/security';
...
```typescript
import { SafeExecutor, createDevelopmentExecutor } from '@ruflo/security';
...
```typescript
import { PathValidator, createProjectPathValidator } from '@ruflo/security';
...
// Sanitize HTML
import { sanitizeHtml } from '@ruflo/security';
...
```typescript
import { TokenGenerator, quickGenerate } from '@ruflo/security';
...
```typescript
import { auditSecurityConfig } from '@ruflo/security';
...
- [@ruflo/swarm](../swarm) - Swarm coordination (secure agent spawning)
