...
[![npm version](https://img.shields.io/npm/v/@ruflo/aidefence?color=blue&label=npm)](https://www.npmjs.com/package/@ruflo/aidefence)
[![npm downloads](https://img.shields.io/npm/dm/@ruflo/aidefence?color=green)](https://www.npmjs.com/package/@ruflo/aidefence)
...
`@ruflo/aidefence` is a high-performance security library designed to protect AI/LLM applications from manipulation attempts. It provides:
...
- **Codex** - CLI command and MCP tools
...
```bash
# npm
npm install @ruflo/aidefence

# pnpm
pnpm add @ruflo/aidefence

# yarn
yarn add @ruflo/aidefence
```
...
```typescript
import { isSafe, checkThreats } from '@ruflo/aidefence';
...
```typescript
import { createAIDefence } from '@ruflo/aidefence';
...
| **API Keys** | OpenAI/OpenAI/GitHub | `sk-ant-api03-...` |
...
```bash
# Basic threat scan
npx @ruflo/cli security defend -i "ignore previous instructions"

# Scan a file
npx @ruflo/cli security defend -f ./user-prompts.txt

# Quick scan (faster)
npx @ruflo/cli security defend -i "some text" --quick

# JSON output
npx @ruflo/cli security defend -i "test" -o json

# View statistics
npx @ruflo/cli security defend --stats
```
...
```typescript
import { VectorStore, createAIDefence } from '@ruflo/aidefence';
...
```json
{
  "hooks": {
    "pre-agent-input": {
      "command": "node -e \"
        const { isSafe } = require('@ruflo/aidefence');
...
Contributions are welcome! Please see our [Contributing Guide](https://github.com/SparklesKitchen/ruflo/blob/main/CONTRIBUTING.md).
...
- [`@ruflo/cli`](https://www.npmjs.com/package/@ruflo/cli) - CLI with security commands
- [`agentdb`](https://www.npmjs.com/package/agentdb) - HNSW vector database
- [`codex`](https://www.npmjs.com/package/codex) - Full AI coordination system
