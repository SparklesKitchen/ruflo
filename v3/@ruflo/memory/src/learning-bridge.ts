 ...
 *
 * @module @ruflo/memory/learning-bridge
 */
...
export interface LearningBridgeConfig {
   ...
   * When provided, this replaces the default dynamic import of @ruflo/neural.
...
export class LearningBridge extends EventEmitter {
  ...
  private async loadNeural(): Promise<void> {
    try {
      ...
      const mod = await import('@ruflo/neural' as string);
      ...
      // @ruflo/neural not installed or failed to initialize.
