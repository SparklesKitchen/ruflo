 ...
 * @example
 * ```typescript
 * import { reasoningBankPlugin } from '@ruflo/plugins/examples/ruvector-plugins';
...
export class ReasoningBank {
   ...
   * When set, uses @ruflo/embeddings for high-quality embeddings
   */
  private embeddingProvider: ((text: string) => Promise<Float32Array>) | null = null;

  /**
   * Set external embedding provider from @ruflo/embeddings
   *
   * @example
   * ```typescript
   ...
   * Used when @ruflo/embeddings is not configured
   */
