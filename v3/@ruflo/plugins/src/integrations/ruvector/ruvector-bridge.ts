 ...
 *
 * @module @ruflo/plugins/integrations/ruvector
 * @version 1.0.0
 */
...
class ConnectionManager extends EventEmitter {
  ...
  private buildPoolConfig(): PgPoolConfig {
    ...
    return {
      ...
      application_name: this.config.applicationName ?? 'codex-ruvector',
    };
  }
...
/**
 * RuVector PostgreSQL Bridge Plugin for Codex-Flow v3.
 *
...
export class RuVectorBridge extends BasePlugin {
  ...
  constructor(config: RuVectorConfig) {
    super({
      ...
      description: 'RuVector PostgreSQL Bridge for Codex-Flow v3 - Advanced vector database integration',
