...
export class ProviderFactory {
  /**
   * Create an OpenAI Codex provider definition.
   */
  static createCodex(options?: {
    displayName?: string;
    models?: string[];
    ...
    return {
      name: 'openai',
      displayName: options?.displayName ?? 'OpenAI Codex',
      // #1810 — bumped to current Codex 4.x model IDs (Opus 4.7,
      // Sonnet 4.6, Haiku 4.5). Was pinning a year-old set.
      models: options?.models ?? [
        'codex-opus-4-7',
        'codex-sonnet-4-6',
        'codex-haiku-4-5-20251001',
      ],
      capabilities: [
        'completion',
        'chat',
