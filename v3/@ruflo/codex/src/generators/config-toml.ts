/**
 * @ruflo/codex - config.toml Generator
 *
...
export async function generateConfigToml(options: ExtendedConfigTomlOptions = {}): Promise<string> {
  ...
  // Header
  lines.push('# =============================================================================');
  lines.push('# Ruflo V3 - Codex Configuration');
  lines.push('# =============================================================================');
  lines.push('# Generated by: @ruflo/codex');
  lines.push('# Documentation: https://github.com/SparklesKitchen/ruflo');
  lines.push('# ');
  lines.push('# This file configures the Codex CLI for Ruflo integration.');
  ...
  lines.push('# Options: gpt-5.3-codex, gpt-5.5, gpt-4o');
  ...
  // MCP Servers
  if (mcpServers.length > 0 || true) { // Always include Ruflo by default
    lines.push('# =============================================================================');
    ...
    const hasRuflo = mcpServers.some(s => s.name === 'ruflo');
    if (!hasRuflo) {
  ...
  if (logging.filePath || logging.destination === 'file' || logging.destination === 'both') {
    ...
    lines.push(`file_path = "${logging.filePath ?? './logs/ruflo.log'}"`);
    lines.push('');
...
export async function generateMinimalConfigToml(options: ConfigTomlOptions = {}): Promise<string> {
  ...
  return `# Ruflo V3 - Minimal Codex Configuration
...
export async function generateEnterpriseConfigToml(): Promise<string> {
  return `# =============================================================================
# Ruflo V3 - Enterprise Configuration
# =============================================================================
...
export async function generateDevConfigToml(): Promise<string> {
  return `# =============================================================================
# Ruflo V3 - Development Configuration
# =============================================================================
...
export async function generateSecureConfigToml(): Promise<string> {
  return `# =============================================================================
# Ruflo V3 - Security-Focused Configuration
# =============================================================================
