 ...
 * remaining 30 stay in @ruflo/cli for now (they pull in heavy ML
 * deps — sona-optimizer, ewc-consolidation, ruvector/*).
 *
 * If a session needs a hooks_* not in this list, it falls through to
 * @ruflo/cli@alpha at the cost of one extra cold-cache hit.
 *
