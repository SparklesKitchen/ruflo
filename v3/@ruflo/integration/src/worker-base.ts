 ...
 *
 * Provides the foundation for all worker patterns in Ruflo v3,
 * aligned with agentic@alpha's worker architecture.
 *
 * Key Features:
 ...
 *
 * This implements ADR-001 by building on agentic patterns
 * while providing Ruflo-specific extensions.
 *
...
import type { Task, TaskResult, AgentStatus, Message } from './agentic-agent.js';
...
/**
 * Agent output interface (compatible with agentic)
 */
