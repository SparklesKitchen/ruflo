...
import { AgenticFlowAgent } from '../agentic-agent.js';
...
describe('AgentAdapter', () => {
  ...
  describe('Agent Conversion from agentic', () => {
    it('should convert agentic agent format', () => {
  ...
  describe('Agent Conversion to agentic', () => {
    it('should convert Ruflo agent to agentic format', async () => {
      const agent = await adapter.createWithDelegation({
        id: 'convert-agent',
        name: 'Convert Test',
        type: 'coder',
  ...
  describe('Delegation Status', () => {
    it('should track delegation status', async () => {
      ...
      // Note: isDelegated will be false unless agentic is actually available
