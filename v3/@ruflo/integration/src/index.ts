/**
 * @ruflo/integration - V3 Integration Module
 *
 * Main entry point for the agentic@alpha integration module.
 * Provides deep integration with SONA learning, Flash Attention,
 * and AgentDB for maximum performance and capability.
 *
 * This module implements ADR-001: Adopt agentic as Core Foundation
 *
 * Key Features:
 ...
 * Usage:
 * ```typescript
 * import { createAgenticFlowBridge } from '@ruflo/integration';
 *
...
// ===== Swarm Adapter (agentic pattern alignment) =====
export {
  SwarmAdapter,
  createSwarmAdapter,
...
export const METADATA = {
  ...
  version: VERSION,
  description: 'Deep agentic@alpha integration for codex v3',
  implements: ['ADR-001'],
  features: [
    ...
    'Worker Patterns (agentic aligned)',
