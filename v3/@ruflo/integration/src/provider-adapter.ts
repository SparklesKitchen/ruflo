 ...
 * (OpenAI, OpenAI, local models, etc.) with automatic selection,
 ...
 *
 * Compatible with agentic's provider manager patterns.
 *
...
import type { Task } from './agentic-agent.js';
