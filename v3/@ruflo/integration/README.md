...
[![npm version](https://img.shields.io/npm/v/@ruflo/integration.svg)](https://www.npmjs.com/package/@ruflo/integration)
[![npm downloads](https://img.shields.io/npm/dm/@ruflo/integration.svg)](https://www.npmjs.com/package/@ruflo/integration)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![ADR-001](https://img.shields.io/badge/ADR--001-Compliant-green.svg)](https://github.com/SparklesKitchen/ruflo)

> Deep agentic@alpha integration module for Ruflo V3 - ADR-001 compliance, code deduplication, SONA adapter, and Flash Attention coordinator.

## Features

- **ADR-001 Compliance** - Eliminates 10,000+ duplicate lines by building on agentic
...
- **Graceful Fallback** - Works with or without agentic installed

## Installation

```bash
npm install @ruflo/integration

# Optional: Install agentic for optimal performance
...
```typescript
import { AgenticFlowBridge, createAgenticFlowBridge } from '@ruflo/integration';
...
// Check if agentic is connected
if (bridge.isAgenticFlowConnected()) {
  console.log('Using optimized agentic implementation');
} else {
...
// Direct agentic access (when available)
...
bridge.on('agentic:connected', ({ version, features }) => {
  console.log(`Connected to agentic ${version}`);
});

bridge.on('agentic:fallback', ({ reason }) => {
...
- `agentic@^0.1.0` (optional, for optimal performance)

## Related Packages

- [@ruflo/neural](../neural) - SONA learning module
- [@ruflo/memory](../memory) - AgentDB memory
- [@ruflo/performance](../performance) - Benchmarking
