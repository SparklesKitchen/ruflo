...
[![npm version](https://img.shields.io/npm/v/@ruflo/neural.svg)](https://www.npmjs.com/package/@ruflo/neural)
[![npm downloads](https://img.shields.io/npm/dm/@ruflo/neural.svg)](https://www.npmjs.com/package/@ruflo/neural)
...
```typescript
import { createNeuralLearningSystem } from '@ruflo/neural';
...
```typescript
import { createSONAManager, type Trajectory } from '@ruflo/neural';
...
import { createAlgorithm, getDefaultConfig } from '@ruflo/neural';
...
If you're building a Ruflo plugin that wants neural learning, depend on `@ruflo/neural` directly rather than reaching into cli internals.

## Dependencies

- [`@ruflo/memory`](../memory) — vector memory for patterns
- `@ruvector/sona` — SONA learning engine

## Related packages

- [`@ruflo/memory`](../memory) — memory backend
- [`@ruflo/cli`](../cli) — primary consumer + MCP tool surface
- [`@ruflo/cli-core`](../cli-core) — lite path (no neural; for plugin scripts)
