...
```typescript
import { createEventBus } from '@ruflo/shared/core';
import { createHookRegistry, createHookExecutor } from '@ruflo/shared/hooks';
import { EventStore } from '@ruflo/shared/events';
...
```typescript
import { HookEvent, HookContext } from '@ruflo/shared/hooks';
...
import { Plugin } from '@ruflo/shared';
import { HookEvent, HookPriority } from '@ruflo/shared/hooks';
...
```typescript
// v3/@ruflo/shared/src/mcp/tools/hooks.ts
