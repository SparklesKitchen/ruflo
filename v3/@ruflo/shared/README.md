...
[![npm version](https://img.shields.io/npm/v/@ruflo/shared.svg)](https://www.npmjs.com/package/@ruflo/shared)
[![npm downloads](https://img.shields.io/npm/dm/@ruflo/shared.svg)](https://www.npmjs.com/package/@ruflo/shared)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Core](https://img.shields.io/badge/Module-Core-blue.svg)](https://github.com/SparklesKitchen/ruflo)

> Shared utilities, types, and core infrastructure for Ruflo V3 - the foundation module used by all other @codex packages.
...
import { ... } from '@ruflo/shared';

// Submodule exports (for tree-shaking or specific imports)
import { ... } from '@ruflo/shared/types';      // Type definitions
import { ... } from '@ruflo/shared/core';       // Config, interfaces, orchestrator
import { ... } from '@ruflo/shared/events';     // Event sourcing (ADR-007)
import { ... } from '@ruflo/shared/hooks';      // Hooks system
import { ... } from '@ruflo/shared/mcp';        // MCP server infrastructure
import { ... } from '@ruflo/shared/security';   // Security utilities
import { ... } from '@ruflo/shared/resilience'; // Retry, circuit breaker, rate limiter
```
...
```typescript
import { EventBus, EventCoordinator } from '@ruflo/shared/events';
...
```typescript
import { HooksManager, Hook } from '@ruflo/shared/hooks';
...
```typescript
import { HealthMonitor, HealthCheck } from '@ruflo/shared/core';
...
This package is a dependency of all other @codex modules:

- [@ruflo/cli](../cli) - CLI module
- [@ruflo/security](../security) - Security & validation
- [@ruflo/memory](../memory) - AgentDB & HNSW indexing
- [@ruflo/neural](../neural) - SONA learning & RL algorithms
- [@ruflo/performance](../performance) - Benchmarking & optimization
- [@ruflo/swarm](../swarm) - 15-agent coordination
- [@ruflo/integration](../integration) - agentic@alpha bridge
- [@ruflo/testing](../testing) - TDD framework & fixtures
- [@ruflo/deployment](../deployment) - Release management
- [@ruflo/embeddings](../embeddings) - Embedding service
- [@ruflo/hooks](../hooks) - Hooks system
