...
**Updated Files**:
- ✅ `/v3/@ruflo/shared/src/events/index.ts` - Module exports
- ✅ `/v3/@ruflo/shared/src/index.ts` - Main module integration
- ✅ `/v3/@ruflo/shared/package.json` - Dependencies added

## File Structure

```
v3/@ruflo/shared/src/events/
...
```typescript
import { EventStore, createAgentSpawnedEvent } from '@ruflo/shared/events';
...
```typescript
import { AgentStateProjection } from '@ruflo/shared/events';
...
# Run example
npx tsx v3/@ruflo/shared/src/events/example-usage.ts
```
...
**Module location**: `/workspaces/codex/v3/@ruflo/shared/src/events/`
