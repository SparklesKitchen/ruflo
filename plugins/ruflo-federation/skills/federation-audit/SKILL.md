...
allowed-tools: Bash(npx *) mcp__codex__memory_search Read Grep
...
2. `npx -y -p @ruflo/plugin-agent-federation@latest ruflo-federation audit --compliance MODE --since DATE --severity LEVEL`
