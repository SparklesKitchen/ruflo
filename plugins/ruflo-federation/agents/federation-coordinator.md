...
- `npx -y -p @ruflo/plugin-agent-federation@latest ruflo-federation init` -- generate keypair, create config
- `npx -y -p @ruflo/plugin-agent-federation@latest ruflo-federation join <endpoint>` -- connect to peer
- `npx -y -p @ruflo/plugin-agent-federation@latest ruflo-federation peers` -- list peers with trust levels
- `npx -y -p @ruflo/plugin-agent-federation@latest ruflo-federation status` -- health dashboard
- `npx -y -p @ruflo/plugin-agent-federation@latest ruflo-federation audit --compliance hipaa` -- audit logs
- `npx -y -p @ruflo/plugin-agent-federation@latest ruflo-federation trust <node-id> --review` -- trust breakdown
- `npx -y -p @ruflo/plugin-agent-federation@latest ruflo-federation send <node-id> <msg-type> <payload> [--max-hops N] [--max-tokens N] [--max-usd N]` -- delegate with budget guardrails
...
```bash
npx @ruflo/cli@latest memory store --namespace federation --key "peer-NODEID" --value "TRUST_HISTORY"
```
