...
Steps:
1. `npx -y -p @ruflo/plugin-iot-cognitum@latest cognitum-iot anomalies DEVICE_ID`
...
4. Store anomaly pattern for learning:
   `mcp__codex__memory_store({ key: "iot-anomaly-DEVICEID", value: "TYPE at SCORE", namespace: "iot-anomalies" })`
