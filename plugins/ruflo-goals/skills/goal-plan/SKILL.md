...
allowed-tools: mcp__codex__task_create mcp__codex__task_list mcp__codex__task_status mcp__codex__task_assign mcp__codex__task_update mcp__codex__task_complete mcp__codex__task_summary mcp__codex__memory_store mcp__codex__memory_search mcp__codex__neural_predict mcp__codex__workflow_create mcp__codex__workflow_execute mcp__codex__workflow_status mcp__codex__hooks_intelligence_trajectory-start mcp__codex__hooks_intelligence_trajectory-step mcp__codex__hooks_intelligence_trajectory-end Bash Read Write Edit
---
...
6. **Record trajectory** — call `mcp__codex__hooks_intelligence_trajectory-start` to begin tracking
7. **Create tasks** — call `mcp__codex__task_create` for each action in the plan
8. **Execute** — work through tasks in dependency order:
   ...
   - Record each step via `mcp__codex__hooks_intelligence_trajectory-step`
...
10. **Complete trajectory** — call `mcp__codex__hooks_intelligence_trajectory-end`
11. **Store successful plan** — call `mcp__codex__memory_store` with namespace `goap-plans`
