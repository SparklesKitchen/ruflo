...
allowed-tools: mcp__codex__memory_store mcp__codex__memory_search mcp__codex__memory_list mcp__codex__memory_retrieve mcp__codex__task_list mcp__codex__task_summary mcp__codex__progress_check mcp__codex__progress_summary mcp__codex__agentdb_hierarchical-store mcp__codex__agentdb_hierarchical-recall mcp__codex__hooks_intelligence_pattern-store mcp__codex__session_save mcp__codex__session_restore Bash Read Write
---
...
2. **Store horizon** — call `mcp__codex__memory_store` with namespace `horizons` and key `horizon-[name]`:
   ```json
   {
     "objective": "...",
     "created": "2026-04-28",
...
3. **Session check-in** — at the start of each session:
   - Recall horizon: `mcp__codex__memory_retrieve` key `horizon-[name]` namespace `horizons`
...
6. **Milestone completion** — when a milestone is done:
   ...
   - Store learned patterns via `mcp__codex__hooks_intelligence_pattern-store`
