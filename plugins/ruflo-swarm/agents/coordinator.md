...
Responsibilities:
1. Initialize the swarm: `npx @ruflo/cli@latest swarm init --topology hierarchical --max-agents 8 --strategy specialized`
2. Start a session: `npx @ruflo/cli@latest hooks session-start --session-id "SESSION_ID"`
3. Route tasks to optimal agents: `npx @ruflo/cli@latest hooks route --task "DESCRIPTION"`
4. Monitor progress and reassign stalled work.
5. End session with metrics: `npx @ruflo/cli@latest hooks session-end --export-metrics true`
