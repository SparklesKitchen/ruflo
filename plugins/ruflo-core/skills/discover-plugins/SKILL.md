...
allowed-tools: mcp__codex__transfer_plugin-search mcp__codex__transfer_plugin-info mcp__codex__transfer_plugin-featured mcp__codex__transfer_plugin-official mcp__codex__transfer_store-search mcp__codex__transfer_store-featured mcp__codex__transfer_store-trending mcp__codex__transfer_store-info mcp__codex__guidance_discover mcp__codex__guidance_recommend mcp__codex__guidance_capabilities mcp__codex__mcp_status Bash Read
---
...
2. **Browse marketplace** — call `mcp__codex__transfer_plugin-featured` for recommended plugins
3. **Search by need** — call `mcp__codex__transfer_plugin-search` with keywords matching your task
4. **Get recommendations** — call `mcp__codex__guidance_recommend` with your current task description for personalized suggestions
5. **Check capabilities** — call `mcp__codex__guidance_capabilities` to see what each plugin enables
6. **Show details** — call `mcp__codex__transfer_plugin-info` for full plugin details
