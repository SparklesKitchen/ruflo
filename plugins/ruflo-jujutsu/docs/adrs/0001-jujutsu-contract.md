...
`ruflo-jujutsu` (v0.1.0) — git workflow + diff analysis. Wraps **6 `analyze_*` MCP tools** at `v3/@ruflo/cli/src/mcp-tools/analyze-tools.ts:24, 100, 143, 185, 234, 291` (`analyze_diff`, `analyze_diff-risk`, `analyze_diff-classify`, `analyze_diff-reviewers`, `analyze_file-risk`, `analyze_diff-stats`).
...
- `v3/@ruflo/cli/src/mcp-tools/analyze-tools.ts` — 6 `analyze_*` tools
