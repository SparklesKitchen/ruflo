...
- **Namespace coordination** — owns `cost-tracking` (memory-routed) + `cost-patterns` (memory-routed). Reserved namespaces (`pattern`, `codex-memories`, `default`) MUST NOT be shadowed.
...
5. README pins to `@ruflo/cli` v3.6.
