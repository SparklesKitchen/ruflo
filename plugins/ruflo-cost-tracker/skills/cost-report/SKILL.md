...
allowed-tools: mcp__codex__memory_search mcp__codex__memory_list mcp__codex__memory_retrieve mcp__codex__agentdb_pattern-search mcp__codex__agentdb_semantic-route Bash
---
...
```bash
npx @ruflo/cli@latest memory search --query "cost report for today" --namespace cost-tracking
npx @ruflo/cli@latest memory list --namespace cost-tracking
```
