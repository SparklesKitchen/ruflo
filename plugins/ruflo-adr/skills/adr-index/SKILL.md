...
argument-hint: ""
allowed-tools: Bash mcp__codex__memory_list mcp__codex__memory_search
---
...
4. **Search semantically** via `mcp__codex__memory_search` against the populated namespace:
