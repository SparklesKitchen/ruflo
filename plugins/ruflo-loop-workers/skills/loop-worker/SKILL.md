---
name: loop-worker
description: Run Ruflo background workers using Codex native /loop scheduling
argument-hint: "<worker-name>"
allowed-tools: Bash(npx *) mcp__codex__hooks_worker-dispatch mcp__codex__hooks_worker-status ScheduleWakeup
---
...
Dispatch a worker via MCP: `mcp__codex__hooks_worker-dispatch({ trigger: "WORKER_NAME" })`
