...
allowed-tools: Bash Read mcp__codex__memory_store mcp__codex__memory_search mcp__codex__neural_train
...
6. Store model results:
   `mcp__codex__memory_store({ key: "model-MODEL-TICKER-DATE", value: "TRAINING_RESULTS", namespace: "trading-models" })`
7. Train SONA on model outcomes:
   `mcp__codex__neural_train({ patternType: "trading-model", epochs: 10 })`
