...
allowed-tools: mcp__codex__session_save mcp__codex__session_restore mcp__codex__session_list mcp__codex__session_info mcp__codex__session_delete mcp__codex__hooks_session-start mcp__codex__hooks_session-end mcp__codex__hooks_session-restore Bash
---
...
1. **Save session** — call `mcp__codex__session_save` to snapshot current state
2. **List sessions** — call `mcp__codex__session_list` to see all saved sessions
3. **Restore** — call `mcp__codex__session_restore` to resume a previous session
4. **Info** — call `mcp__codex__session_info` for session details and metadata
5. **Clean up** — call `mcp__codex__session_delete` to remove old sessions
