...
5. Dispatch doc worker for large-scale generation: `npx @ruflo/cli@latest hooks worker dispatch --trigger document`
...
- `npx @ruflo/cli@latest hooks worker dispatch --trigger document` — bulk generation
