...
**Full project**: `npx @ruflo/cli@latest hooks worker dispatch --trigger document`
**Specific scope**: `npx @ruflo/cli@latest hooks worker dispatch --trigger document --scope api`
