...
argument-hint: "<name>"
allowed-tools: Read Write Glob Bash mcp__codex__memory_store mcp__codex__memory_search mcp__codex__agentdb_pattern-search
---
