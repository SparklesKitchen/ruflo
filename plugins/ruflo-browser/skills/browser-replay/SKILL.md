...
allowed-tools: mcp__codex__browser_open mcp__codex__browser_close mcp__codex__browser_click mcp__codex__browser_fill mcp__codex__browser_type mcp__codex__browser_press mcp__codex__browser_select mcp__codex__browser_check mcp__codex__browser_uncheck mcp__codex__browser_hover mcp__codex__browser_wait mcp__codex__browser_screenshot mcp__codex__browser_snapshot mcp__codex__browser_eval Bash Read
---
...
3. **Open a fresh browser** via `mcp__codex__browser_open` (target URL = original or `--url` override).
