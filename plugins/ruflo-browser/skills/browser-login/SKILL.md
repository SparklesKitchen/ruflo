...
allowed-tools: mcp__codex__browser_open mcp__codex__browser_close mcp__codex__browser_fill mcp__codex__browser_type mcp__codex__browser_click mcp__codex__browser_wait mcp__codex__browser_eval mcp__codex__browser_snapshot mcp__codex__aidefence_scan mcp__codex__aidefence_has_pii Bash Read Write
---
...
6. **Store in `browser-cookies`**:
   ```bash
   npx -y @ruflo/cli@latest memory store --namespace browser-cookies \
     --key "<host>" \
