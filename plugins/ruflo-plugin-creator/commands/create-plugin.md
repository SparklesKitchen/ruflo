---
name: create-plugin
description: Scaffold a new Codex plugin interactively
---

Create a new Codex plugin:
...
4. Show the user what was created and how to test it with `codex --plugin-dir ./plugins/<name>`
