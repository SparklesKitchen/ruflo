...
allowed-tools: Bash Read mcp__codex__memory_search mcp__codex__memory_store mcp__codex__memory_list
---
...
4. **Store results**:
   `mcp__codex__memory_store({ key: "clusters-PROJECT-TIMESTAMP", value: "CLUSTER_ASSIGNMENTS", namespace: "vector-clusters" })`
