# Codex-Flow Deep Regression Test Suite

Comprehensive Docker-based test suite for verifying all Codex-Flow capabilities.
...
| `RUFLO_MODE` | `test` | Operating mode |
| `RUFLO_MEMORY_PATH` | `/app/data` | Memory storage path |
| `RUFLO_LOG_LEVEL` | `debug` | Log verbosity |
...
|---------|-------|-----------|
| @ruflo/hooks | 112 | 100% |
| @ruflo/plugins | 142 | 100% |
| @ruflo/security | 47 | 100% |
| @ruflo/swarm | 89 | 100% |
| @ruflo/cli | 34 | 100% |
