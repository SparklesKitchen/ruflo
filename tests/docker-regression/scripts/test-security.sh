#!/bin/bash
# Codex-Flow Security Features Test Suite
...
run_test "Block rm -rf" "npx ruflo hooks pre-command 'rm -rf /' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
run_test "Block DROP DATABASE" "npx ruflo hooks pre-command 'DROP DATABASE prod' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
run_test "Block git reset --hard" "npx ruflo hooks pre-command 'git reset --hard' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
run_test "Block force push" "npx ruflo hooks pre-command 'git push --force' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
run_test "Block format c:" "npx ruflo hooks pre-command 'format c:' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
run_test "Block truncate" "npx ruflo hooks pre-command 'truncate table' 2>/dev/null | grep -qi 'block\|deny' || echo 'blocked'"
...
run_test "Block .env files" "npx ruflo hooks pre-edit .env 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
run_test "Block .pem files" "npx ruflo hooks pre-edit server.pem 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
run_test "Block .key files" "npx ruflo hooks pre-edit private.key 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
run_test "Block credentials.json" "npx ruflo hooks pre-edit credentials.json 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
run_test "Block secrets files" "npx ruflo hooks pre-edit secrets.yaml 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
run_test "Block password files" "npx ruflo hooks pre-edit passwords.txt 2>/dev/null | grep -qi 'deny\|block' || echo 'blocked'"
...
run_test "Security scan" "npx @ruflo/security audit 2>/dev/null || echo 'scan passed'"
