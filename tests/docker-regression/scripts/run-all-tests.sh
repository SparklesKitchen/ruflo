#!/bin/bash
# Codex-Flow Deep Regression Test Suite - Main Runner
...
LOG_DIR="${RUFLO_LOG_DIR:-/app/logs}"
...
echo -e "${CYAN}╔════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║     RUFLO DEEP REGRESSION TEST SUITE                     ║${NC}"
...
cat > "$REPORT_FILE" << EOF
{
  "testSuite": "codex-deep-regression",
  "version": "3.0.0",
...
RUFLO DEEP REGRESSION TEST SUMMARY
========================================
Date: $(date)
Version: 3.0.0
